...
**[agent-defense-eval](https://github.com/0x71pp17/agent-defense-eval)** Evaluation harness that
scores agent-authorization defenses against the AgentDojo benchmark on injection blocking and
